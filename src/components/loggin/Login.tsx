...
<input type="email" name="email" placeholder="Example@rest.com" onChange={handleInputChange} required  />
<input type="password" name="password" placeholder="At least 6 charchters" onChange={handleInputChange} required />
<button>Login</button>
